...
var LayerNearbyConnection = cc.Layer.extend({
    ...
    __createMenu : function() {
        ...
        const menu = new cc.Menu(
            new cc.MenuItemFont("StartAdvertising", function() {
                _context.gameServices().NearbyConnection.StartAdvertising(
                    ...
                    function(str_json) {
                        ...
                        __log("GPG advertising:" + str_json);
                    },
                    function() {
                        //request_callback
                        __log("GPG request:" + str_json);
                    });
            }),
            new cc.MenuItemFont("StopAdvertising", function() {
            ...
            new cc.MenuItemFont("StartDiscovery", function() {
                const server_id = '';
                _context.gameServices().NearbyConnection.StartDiscovery(server_id, 0,
                    function(str_json) {
                        __log('GPG discovery:' + str_json);
                    });
            }),
            new cc.MenuItemFont("StopDiscovery", function() {
                const server_id = '';
            ...
            new cc.MenuItemFont("SendReliableMessage", function() {
                const remote_endpoint_id = '';
                const payload = 'this message';
                _context.gameServices().NearbyConnection.SendReliableMessage(
                    remote_endpoint_id, payload);
            }),
            new cc.MenuItemFont("SendUnreliableMessage", function() {
                const remote_endpoint_id = '';
            ...
            new cc.MenuItemFont("Stop", function() {
        ...
        // console.log(gs);
        if (!_context.gameServices().NearbyConnection.Init("{\"LogLevel\":1,\"ClientID\":0,\"ServiceID\":\"com.sdkbox.hugo.test.gpg.nearby\"}", function(result) {
